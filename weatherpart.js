...
$.ajax({
    ...
    var currentAustinWeather = displayAustinWeather.append("<p>" + "Austin" + "</p>");
    displayAustinWeather.append(currentAustinWeather);

    // currentAustinWeather.append(`<img src="https://openweathermap.org/img/wn/${response.weather[0].icon}@2x.png">`);
